...
<html>
	...
	<body>
		<a href="#edit-cicloMateria" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-cicloMateria" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${cicloMateriaInstance?.version}" />
				<fieldset class="form">
