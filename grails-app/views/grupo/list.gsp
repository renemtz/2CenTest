			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="grupo.carrera.label" default="Carrera" /></th>
					
						<th><g:message code="grupo.ciclo.label" default="Ciclo" /></th>
				...
				<g:each in="${grupoInstanceList}" status="i" var="grupoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: grupoInstance, field: "carrera")}</td>
					
						<td>${fieldValue(bean: grupoInstance, field: "ciclo")}</td>
